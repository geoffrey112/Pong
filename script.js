...
function openKeyBtn(event){
  ...
  if(event.type === "click"){
    ...
    setTimeout(() => { containKey.classList.add('containKeyOut'); }, 10);

    btnKey.classList.remove('closeKey');
    btnKey.classList.add('openKey');
    containCardKey.classList.add('containCardKey');
    setTimeout(() => { containCardKey.classList.add('cardKeyIn'); }, 10); // Short delay
...
function closeKeyBtn(event){
  ...
  if(!event.target.closest('div.buttonKey')){
    ...
    setTimeout(() => {
      ...
      btnKey.classList.remove('openKey');
      btnKey.classList.add('closeKey');
    },500);
    setTimeout(() => {
      containKey.classList.remove('containKeyOut');
      containKey.classList.add('containKeyIn');
    }, 1000);
    setTimeout(() => {
      btnKey.classList.remove('closeKey');
    }, 1500);
